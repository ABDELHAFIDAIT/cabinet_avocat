    ...
    <main>
        <section>
            ...
            <div class="m-5 flex flex-wrap items-center gap-5 md:grid md:grid-cols-2 lg:grid-cols-3 lg:gap-8 lg:mx-16 lg:mb-10">
                <div class="bg-[#02101f] p-10 rounded-sm">
                    <div class="flex flex-col items-center justify-center gap-2 mb-7">
                        ...
                        <h1 class="font-semibold text-xl">Jhoe Doe</h1>
                        <p class="text-gray-300">Avocat en <span class="text-[#01FF70] font-medium text-lg">Droit Civil</span></p>
                    </div>
                    <div class="flex flex-col gap-2 mb-5">
                        <h1 class="font-semibold text-lg">Biographie</h1>
                        <p class="text-gray-300 text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur earum eaque blanditiis, odio necessitatibus voluptas tenetur reiciendis dolorem. Maiores, enim!</p>
                    </div>
                    <div class="flex flex-col gap-2">
                        ...
                        <ul style="list-style-type: disc;" class="ml-10 flex flex-col gap-2">
                            <li class="text-gray-300">jhoe.doe@gmail.com</li>
                            <li class="text-gray-300">+212 612345678</li>
                        </ul>
                    </div>
                </div>
