            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-4xl w-full p-8 transition-all duration-300 animate-fade-in">
                <div class="flex flex-col md:flex-row">
                    <div class="md:w-1/3 text-center mb-8 md:mb-0">
                        ...
                        <p class="text-gray-600 dark:text-gray-300">Avocat Spécialisé</p>
                    </div>
                    <div class="md:w-2/3 md:pl-8">
                        <h2 class="text-xl font-semibold text-indigo-800 dark:text-white mb-4">BIOGRAPHIE</h2>
                        ...
                        <h2 class="text-xl font-semibold text-indigo-800 dark:text-white mb-4">Spécialité</h2>
                        <div class="flex flex-wrap gap-2 mb-6">
                            <span class="bg-indigo-100 text-indigo-800 px-3 py-1 rounded-full text-sm">Droit Civil</span>
                        </div>
                        <h2 class="text-xl font-semibold text-indigo-800 dark:text-white mb-4">Contact</h2>
